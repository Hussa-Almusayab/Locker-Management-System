...
![Locker Management System Banner](Locker%20Management%20System.png)

## 🎓 Computer Software Diploma Project
هذا المشروع هو متطلب التخرج لتخصص **دبلوم برمجيات الحاسب**. يهدف النظام إلى أتمتة إدارة الخزائن وتسهيل عملية الحجز والتتبع بشكل آمن وفعال.

---

## 👥 فريق العمل (Development Team)
تم تطوير هذا المشروع بجهد مشترك من قبل المتدربات (مرتبة أبجدياً):
1. **حصة المسيب** (Hussah Al-Musaib)
